...
if (isset($_POST['search'])) {
    ...
    if (empty($room)) {
        ...
        header('Location: bookingstd.php');
        exit;
    }
...
header('Location: bookingstd.php?result=' . urlencode(json_encode($result)) . '&timeSlots=' . urlencode(json_encode($timeSlots)) . '&room=' . urlencode($room) . '&date=' . urlencode($dateroom) . '&roomStatus=' . urlencode($roomStatus));
exit;
?>