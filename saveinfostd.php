...
<head>
    ...
    <!-- CSS -->
    <!-- <link rel="stylesheet" href="css/stdsave.css"> -->
    <!-- <link rel="stylesheet" href="css/stystdsave.css"> -->
    <link rel="stylesheet" href="css/infosave-std.css">

    <title>Save Information Student</title>
</head>
...
<body>
    ...
    <main>
        ...
        <div id="container">
            ...
            <form action="saveinfostd_db.php" method="post">
