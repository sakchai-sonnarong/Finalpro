...
<head>
    ...
    <!-- <link rel="stylesheet" href="css/reportdoc-teach.css"> -->
    <link rel="stylesheet" href="css/adreportdoc-teach.css">
    ...
    <main>
        ...
        <div id="container">
            ...
            <div class="name-formstd">
                <h4>รายงานการใช้แบบฟอร์มของอาจารย์</h4>
            </div>
            <table>
                <tr>
                    <th>ลำดับ</th>
                ...
                MT.member_type_id=2 GROUP BY DF.document_form_id";
