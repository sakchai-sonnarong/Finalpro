...
<head>
    ...
    <!-- CSS -->
    <!-- <link rel="stylesheet" href="css/stylerequestd.css"> -->
    <link rel="stylesheet" href="css/stdreque.css">

    <title>Student requestd</title>
</head>
...
<body>
    ...
    <main>
        ...
        <div id="container">
            <form action="requestd_db.php" method="post">
                ...
                if (isset($_SESSION['student_login'])) {
                    ...
                    $stmt = $conn->prepare("SELECT * FROM member WHERE member_id = :student_id");
                ...
                <div class="line">
                    ...
                    <input type="text" class="form_control" name="service_request_Basicdetails" aria-describedby="service_request_Basicdetails">
                </div>
                <div class="line">
