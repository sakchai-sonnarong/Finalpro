...
<head>
    ...
    <!-- <link rel="stylesheet" href="css/tbookingroom.css"> -->
    <!-- <link rel="stylesheet" href="css/tbookingr.css"> -->
    <link rel="stylesheet" href="css/teachbkr.css">
...
<body>
    ...
    <main>
        ...
        <div id="container">
            ...
            <form action="teachbookingroom_db.php" method="post">
                <div class="details">
                    <?php
                    ...
                    if (isset($_SESSION['teacher_login'])) {
                        ...
                        $stmt = $conn->query("SELECT * FROM member WHERE member_id = $teacher_id");
                        $stmt->execute();
                    ...
                    <label class="name" for="name">ชื่อ-นามสกุล: <?php echo $row['member_name'] . ' ' . $row['member_lastname'] ?></label>
