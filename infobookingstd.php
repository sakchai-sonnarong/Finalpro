...
$member_id = $_SESSION['student_login'];
...
<head>
    ...
    <!-- CSS -->
    <!-- <link rel="stylesheet" href="css/stdinfobgr.css"> -->
    <link rel="stylesheet" href="css/std-infobgr.css">

    <title>Information Booking-Room Student</title>
    ...
    <main>
        ...
        <div class="container">
            ...
            <table>
                ...
                // ดึงข้อมูลจากฐานข้อมูล
                $member_id = $_SESSION['student_login'];
                $sql = "SELECT b.booking_id, m.member_name, m.member_lastname, r.room_name, b.booking_date, b.booking_time_in, b.booking_time_out, b.status, b.booking_time_in
                FROM booking_room b
                JOIN member m ON b.member_id = m.member_id
                JOIN room r ON b.room_id = r.room_id
                WHERE b.member_id = :member_id";
                ...
                foreach ($bookings as $row) {
                    ...
                    echo "<form method='POST' action='showmybookingstd_db.php'>";
