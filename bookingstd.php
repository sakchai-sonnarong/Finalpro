...
<head>
    ...
    <!-- CSS -->
    <!-- <link rel="stylesheet" href="css/stylestdbooking.css"> -->
    <link rel="stylesheet" href="css/stybookr.css">
    ...
    <script>
        function bookRoom(startTime, endTime, room, date) {
            ...
            form.method = 'POST';
            form.action = 'studentbookingroom.php';
        ...
        <div id="container">
            <div class="title">
                ...
                <?php if (isset($_SESSION['error'])) { ?>
                    ...
                    <?php } ?>
                <form action="studentshowbookingroom_db.php" method="POST">
                        ...
                        <table>
                            ...
                            foreach ($result as $row) {
                                ...
                                if ($time >= date("H:i", strtotime($bookingStart)) && $time < date("H:i", strtotime($bookingEnd))) {
                                    ...
                                    $statusText = $row['status'] == "กำลังใช้งาน" ? "กำลังใช้งาน" : ($row['status'] == "ใช้งานเสร็จสิ้น" ? "ใช้งานเสร็จสิ้น" : "จองแล้ว");
                                    break;
                                }
                            }
