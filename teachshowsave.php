...
<head>
    ...
    <!-- CSS -->
    <!-- <link rel="stylesheet" href="css/tshowsave.css"> -->
    <link rel="stylesheet" href="css/teach-showsave.css">
    ...
    <script>
        ...
        function handleEdit() {
            ...
            window.location.href = "teacheditsave.php?service_request_id=" + window.servicerequestid;
        }
    ...
    <main>
        ...
        <div id="container">
            ...
            <table>
                ...
                WHERE sr.member_id_student = :teacher_id";
                $stmt = $conn->prepare($sql);
                $stmt->bindParam(':teacher_id', $teacher_login);
                $stmt->execute();
